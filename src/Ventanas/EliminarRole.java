...
public class EliminarRole extends javax.swing.JFrame {

  
    Service s;
    List<String> tablas;

    public EliminarRole(Service servicio) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        Query consulta = new Query("DROP ROLE "+delete);
    ...
    private void llenarTabla () {
         int[] col = {0,1};
        Query consulta = new Query("SELECT * FROM DBA_ROLES");
        tablas = consulta.cargarTablas(this.s,"role");
