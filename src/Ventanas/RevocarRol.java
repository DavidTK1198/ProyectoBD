...
public class RevocarRol extends javax.swing.JFrame {
    ...
    public RevocarRol(Service servicio) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("QUITAR ROL A USUARIO");
    ...
    private void btnAsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAsignarActionPerformed
        ...
        Query consulta = new Query("REVOKE "+selected2+" FROM "+selected);
        this.txtResultado.setText(consulta.executeQuery(s,"5"));
        this.llenarTablas();
    ...
    private void llenarTablas () {
        ...
        TableModelUsuario table= new TableModelUsuario(tablas,col);
         consulta = new Query("SELECT * FROM DBA_ROLES");
        tablas2 = consulta.cargarTablas(this.s,"role");
